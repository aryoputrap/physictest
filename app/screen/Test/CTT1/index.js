...
export default class App extends Component {
  ...
  kirimJawaban = () => {
    clearInterval(this.state.waktu);
    this.setState({
      loading: true,
      minutes_Counter: '00',
      seconds_Counter: '00',
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View>
                ...
                { jwb.tier11 && jwb.tier12 && jwb.tier13 && jwb.tier14 === 'null' || ''  ?
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View>
                ...
                { jwb.tier31 && jwb.tier32 && jwb.tier33 && jwb.tier34 === 'null' || ''  ?
                  <View style={style.buttonf}>
                    <Text style={style.textbtn}>SOAL BELUM TERISI</Text>
                  </View>
                :
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View>
                ...
                { jwb.tier41 && jwb.tier42 && jwb.tier43 && jwb.tier44 === 'null' || ''  ?
                  <View style={style.buttonf}>
                    <Text style={style.textbtn}>SOAL BELUM TERISI</Text>
                  </View>
                :
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View>
                ...
                { jwb.tier51 && jwb.tier52 && jwb.tier53 === 'null' || ''  ?
                  <View style={style.buttonf}>
                    <Text style={style.textbtn}>SOAL BELUM TERISI</Text>
                  </View>
                :
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View>
                ...
                { jwb.tier71 && jwb.tier72 && jwb.tier73 && jwb.tier74 === 'null' || ''  ?
                  <View style={style.buttonf}>
                    <Text style={style.textbtn}>SOAL BELUM TERISI</Text>
                  </View>
                :
  ...
  showMsg() {
    ...
    this.setState({ waktu });
    this.setState({time: true}, () => timer.setTimeout(
      this, 'hideMsg', () => this.setState({time: false,
        loading: true,
        minutes_Counter: '00',
        seconds_Counter: '00',
        startDisable: false}), 5000000
    ));
  }
      ...
      <View>
        ...
        <View>
            <View style={style.header}>
              ...
              <Text style={style.titlet}>Waktu {this.state.minutes_Counter} : {this.state.seconds_Counter}</Text>
            </View>
