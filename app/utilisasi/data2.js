  ...
  databagian1: [
    {
      ...
      body:
        '<p1 style="textAlign: justify;">Konsep gaya apung dalam suatu fluida seringkali dipahami secara keliru oleh peserta didik sehingga perlu bahan belajar yang dapat memberi penjelasan yang komprehensif untuk membentuk dan merevisi konsep tersebut di benak peserta didik. Dengan demikian, teks ini dibuat untuk keperluan tersebut. Silahkan Anda baca dengan seksama setiap bagian teks dan lakukan aktivitas sesuai yang diminta pada setiap bagian teks dengan sebaik baiknya sesuai pemikiran yang Anda miliki. Tapi sebelum Anda membaca setiap bagian teks silahkan jawab pertanyaan-pertanyaan berikut.</p1>',
      tier1: {
        soal:
          '<p1 style="textAlign: justify;">Dua balok berada pada keadaan terapung di dalam suatu zar cair dengan posisi seperti pada gambar berikut.</p1>',
        soal2:
          '<p1 style="textAlign: justify;">Berdasarkan posisi kedua balok tersebut, gaya apung yang dialami kedua balok adalah…</p1>',
        jwb_a:
          '<p1 style="textAlign: justify;">A. gaya apung yang dialami balok A lebih besar daripada gaya apung yang dialami balok B.</p1>',
        jwb_b:
          '<p1 style="textAlign: justify;">B. gaya apung yang dialami balok B lebih besar daripada gaya apung yang dialami balok A.</p1>',
        jwb_c:
          '<p1 style="textAlign: justify;">C. balok A dan B memiliki gaya apung yang sama besar.</p1>',
      },
      tier2: {
        soal:
      ...
      tier3: {
        ...
        jwb_a:
          '<p1 style="textAlign: justify;">A. gaya apung bergantung pada volume benda di atas permukaan zat cair. Ketika volume benda diatas permukaan zat cair lebih besar dibandingkan volume benda yang tercelup di dalam zat cair menunjukkan bahwa gaya apung benda semakin besar dan begitu juga sebaliknya. Volume balok A di atas permukaan air lebih besar sehingga balok A memiliki gaya apung yang lebih besar daripada balok B.</p1>',
        jwb_b:
          '<p1 style="textAlign: justify;">B. gaya apung bergantung pada volume benda yang tercelup di dalam zat cair. Ketika volume benda yang tercelup di dalam zat cair lebih besar dibandingkan volume benda di atas permukaan zat cair menunjukkan bahwa gaya apung benda semakin besar dan begitu juga sebaliknya. Volume balok B yang tercelup lebih besar sehingga balok Bmemiliki gaya apung yang lebih besar daripada balok C.</p1>',
        jwb_c:
